                    ...
                    <div class="table">
                        ...
                        <#--    <tr>
                            ...
                            <#-- <th width="13"><input type="checkbox" class="checkbox"/></th>-->
                                ...
                                <th><h3>TaskQueueTotalJobs</h3></th>
                                <th><h3>ScheduleTotalJobs</h3></th>
                        ...
                        <#list machines as machine>
                            ...
                            <#-- <td><input type="checkbox" class="checkbox"/></td>-->
                                ...
                                <td align="center"><h3>${machine.taskQueueEntityCount}</td>
                                <td align="center"><h3>${machine.taskQueuetotalJobs}</td>
                                <td align="center"><h3>${machine.scheduleCount}</td>
